...
export const task_8 = function () {
    console.log(`массив обрабатывается по цепочке, каждому элементу массива map добавляет A и значение элемента, после чего возвращаются элементы в новый массив и выводим в консоли A 1 A 2, далее массив [1, 2] передается на второй map, но он как раз не возвращается а делает вывод B 1 B 2`)
    const nums = [1, 2];
